...
Remote Control Server is an independent project and is not affiliated with RustDesk. RustDesk is a trademark of its respective owner; the name is used only to describe protocol compatibility.
